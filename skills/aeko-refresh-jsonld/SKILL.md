...
allowed-tools: aeko_get_product_description, aeko_update_product_description, aeko_list_store_integrations, aeko_list_store_writes, aeko_revert_store_write, WebFetch, Write
---
