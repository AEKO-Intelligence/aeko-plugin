...
- **Boilerplate** — one "About <Brand>" paragraph in the neutral product-led voice, grounded in the
  product facts and domain. Never hard-code "AEKO"; this drafts for the user's domain/brand.
