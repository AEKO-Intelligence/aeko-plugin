...
The Context Reviews feature maps real customer/usage reviews to a product and groups them by
**context** (the situation the product was used in) and **shopper** (who used it). Each entry carries
...
> `{ "product_source_id": "...", "reviews": [ {context, shopper, quote, detail, rating} ] }`
